...
const TemplateGallery = ({templates, windowWidth, handleIsOpenTemplateGallery}) => {
    const color1 = "#F0E0D6";
    const color2 = "#1D7874";
    ...
    return (
        <div className="container gallery-template-container-media" style={{height: height}}>
            ...
            {windowWidth <= 820 && show &&
                <div className="gallery-template-title" onClick={handleClick} style={{backgroundColor: "#852e0f"}}>
